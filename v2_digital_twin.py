...
# ══════════════════════════════════════════════════════════════
# WORKER PROFILES — Option B: carried in Module 2
# Keeps CSV clean, avoids redundant data storage
# ══════════════════════════════════════════════════════════════
WORKER_PROFILES = {
    "W001": {"resting_hr": 62,  "max_hr": 186, "baseline_temp": 36.6,
             "accl_days": 45,  "workload": "heavy",    "name": "Ahmed Al-Rashidi"},
    "W002": {"resting_hr": 71,  "max_hr": 192, "baseline_temp": 36.8,
             "accl_days": 12,  "workload": "heavy",    "name": "Tariq Mahmoud"},
    "W003": {"resting_hr": 78,  "max_hr": 178, "baseline_temp": 36.5,
             "accl_days": 90,  "workload": "moderate", "name": "Khalid Al-Otaibi"},
    "W004": {"resting_hr": 68,  "max_hr": 189, "baseline_temp": 36.7,
             "accl_days": 3,   "workload": "heavy",    "name": "Samir Hassan"},
    "W005": {"resting_hr": 65,  "max_hr": 182, "baseline_temp": 36.6,
             "accl_days": 60,  "workload": "light",    "name": "Faisal Al-Zahrani"},
    "W006": {"resting_hr": 75,  "max_hr": 185, "baseline_temp": 36.9,
             "accl_days": 7,   "workload": "heavy",    "name": "Omar Al-Ghamdi"},
    "W007": {"resting_hr": 70,  "max_hr": 180, "baseline_temp": 36.6,
             "accl_days": 30,  "workload": "moderate", "name": "Nasser Al-Qahtani"},
    "W008": {"resting_hr": 66,  "max_hr": 194, "baseline_temp": 36.5,
             "accl_days": 21,  "workload": "heavy",    "name": "Yusuf Al-Harbi"},
    "W009": {"resting_hr": 80,  "max_hr": 175, "baseline_temp": 36.7,
             "accl_days": 180, "workload": "light",    "name": "Ibrahim Al-Dosari"},
    "W010": {"resting_hr": 63,  "max_hr": 187, "baseline_temp": 36.6,
             "accl_days": 5,   "workload": "heavy",    "name": "Majed Al-Shehri"},
}
...
def main():
    ...
    print(f"\n  Saved: {output_path}")
    print("\nModule 2 complete. Next: python v2_safety_infrastructure.py")
    print("=" * 65)
